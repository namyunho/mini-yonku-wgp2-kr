...
- **규명 완료·문서화 = docs/17**. 월드맵 X메뉴·조작방법 튜토리얼 라벨 = **네 번째 텍스트 경로 System ④**:
...
- **렌더 방식 확정(사용자)** = docs/12 8pt 한글 재사용 + **$C0:1B4B에 0xFE 마커 훅**(SJIS $C1:965E 훅과 동형, KOR_ADD=0x220). ASM 설계 완료(docs/17).
