...
| 빌드·검증 | 🟡 통합 빌드 완료·실기 QA 진행 | `build_all.py`가 정적·그래픽·어드벤처·필드/NPC·월드맵·SJIS·소형 메뉴·Result·포메이션·능력치·개러지·경기 HUD·**VICTORYS 엔딩 로고**와 **챕터 인트로 2bpp 제목 10개**를 **원본과 동일한 2MB ROM 내부**에 통합하고 체크섬 및 BPS를 생성. 정적 681, 어드벤처 **235씬·1,782메시지**, 필드 685레코드, 월드맵 350문자열, 인트로 그래픽 10/10, 경기 HUD 라벨 7타일 + 일본어 윗행 잔재 4타일, 엔딩 로고 CHR·타일맵·로더 2곳 역검증 PASS. 기존 어드벤처 전편 실기 완주 완료, 신규 복구 58런과 승인 그래픽 실기 QA 진행 중 |
