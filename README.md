...
| **정적 대사 673** 추출·번역·재삽입 | ✅ 완료 (674/674 무손실, `build_patch.py` — 포메이션 안내 고아 문자열 `$C1:CFAF` 발굴 복구 포함) |
...
| 시스템 | 규모 | 내용 |
|------|------|------|
| 정적 대사 674 | `c7_race` 232 · `d0_story` 404 · `c1_ui` 38 | 레이스 중계·스토리/배틀 서사·세팅/개러지/포메이션 UI |
